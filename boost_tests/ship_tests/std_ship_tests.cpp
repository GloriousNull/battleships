...
BOOST_AUTO_TEST_SUITE(std_ship_test)
    ...
    {
        std::unique_ptr<std_ship_base> ship_to_test{std::make_unique<std_ship>(0)};
    ...
    {
        std::unique_ptr<std_ship_base> ship_to_test{std::make_unique<std_ship>(4)};
    ...
    BOOST_AUTO_TEST_CASE(size)
    {
        ...
        std::unique_ptr<std_ship_base> ship_to_test{std::make_unique<std_ship>(size)};
